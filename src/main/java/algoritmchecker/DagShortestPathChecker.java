...
import shortestpathalgo.DagShorteshPath;

import java.util.ArrayList;
import java.util.List;
import java.util.Stack;

public class DagShortestPathChecker implements Checker {
    @Override
    public void check() {
        ...
        DagShorteshPath dagShorteshPath = new DagShorteshPath(graph);
        VertexForWeightedGraph source = graph.get(0);
        dagShorteshPath.shortestPathFromSource(source);
